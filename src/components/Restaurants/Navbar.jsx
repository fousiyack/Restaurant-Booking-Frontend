...
const Navbar = () => {
  ...
  useEffect(() => {
    const checkRestaurantEntry = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/restaurant/has-entry/${userId}`);
    ...
    <nav className="bg-gray-800 border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Restaurant Booking </span>
        </a>
